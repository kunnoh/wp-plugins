...
function render_block_listings_block( $attributes ) {
    ...
    $order = isset($attributes['order']) ? $attributes['order'] : 'desc'; // Fixed: removed intval()
    $order_by = isset($attributes['orderBy']) ? $attributes['orderBy'] : 'date'; // Fixed: removed intval()
